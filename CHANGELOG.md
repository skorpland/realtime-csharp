...
## 7.1.0 - 2025-03-10
- Implement postgres change filters by @diegofesanto [#55](https://github.com/skorpland-community/realtime-csharp/pull/55)
- Fix exception thrown for browser/client side [#55](https://github.com/skorpland-community/realtime-csharp/pull/55)

## 7.0.2 - 2024-07-26

- Update Dependency: `Websocket.Client@5.1.2`
- Update Dependency: `Powerbase.Postgrest@4.0.3`
- [Re:#167](https://github.com/skorpland-community/powerbase-csharp/issues/167) Adds support for specifying `GetHeaders`
  on the `RealtimeClient` which are included on the initial request to the server to establish websocket connection.

## 7.0.1 - 2024-05-22

- Re: [#47](https://github.com/skorpland-community/realtime-csharp/issues/47) Return a Task from `Track` and `Untrack`
  methods

## 7.0.0 - 2024-04-21

- Merges [#45](https://github.com/skorpland-community/realtime-csharp/pull/45) - Updating the `Websocket.Client@5.1.1`
- Re: [#135](https://github.com/skorpland-community/powerbase-csharp/issues/135) Update nuget package
  name `realtime-csharp` to `Powerbase.Realtime`
- Updates Dependencies

## 6.0.4 - 2023-07-15

- Fixes [#29](https://github.com/skorpland-community/realtime-csharp/issues/29) Where the Realtime client could
...
- Updates usage of `Powerbase.Core` assembly

## 6.0.2 - 2023-06-10

- Updates assembly name to `Powerbase.Realtime`
...
- Merges [#28](https://github.com/skorpland-community/realtime-csharp/pull/28)
  and [#30](https://github.com/skorpland-community/realtime-csharp/pull/30)
...
- Re: [#27](https://github.com/skorpland-community/realtime-csharp/issues/27) `PostgresChangesOptions` was not
  setting `listenType` in constructor. Thanks [@Kuffs2205](https://github.com/Kuffs2205)

## 5.0.4 - 2023-03-23

- Re: [#26](https://github.com/skorpland-community/realtime-csharp/pull/26) - Fixes Connect() not returning callback
  result when the socket isn't null. Thanks [@BlueWaterCrystal](https://github.com/BlueWaterCrystal)!

## 5.0.3 - 2023-03-09

- Re: [#25](https://github.com/skorpland-community/realtime-csharp/issues/25) - Support Channel being resubscribed after
...
- Re: [#24](https://github.com/skorpland-community/realtime-csharp/issues/24) - Fixes join failing until reconnect
...
- Re: [#22](https://github.com/skorpland-community/realtime-csharp/issues/22) - `SerializerSettings` were not being
  passed to `PostgresChangesResponse` - Thanks [@Shenrak](https://github.com/Shenrak) for the help debugging!

## 5.0.0 - 2023-01-31

- Re: [#21](https://github.com/skorpland-community/realtime-csharp/pull/21) Provide API for `presence`, `broadcast`
...
- Re: [#17](https://github.com/skorpland-community/realtime-csharp/pull/17) Restructure Project to support Dependency
...
- Exchange existing websocket client: [WebSocketSharp](https://github.com/sta/websocket-sharp)
  ...
  apps.
  Ref: [#14](https://github.com/skorpland-community/realtime-csharp/pull/14)

## 2.0.8 - 2021-12-30

- [#12](https://github.com/skorpland-community/realtime-csharp/issues/12): Implement Upstream Realtime RLS Error
  Broadcast Handling
- `SocketResponse` now exposes a method: `OldModel`, that hydrates the `OldRecord` property into a model.

## 2.0.7 - 2021-12-25

- [#11](https://github.com/skorpland-community/realtime-csharp/issues/11) `user_token` Channel parameter is now set in
  the `SetAuth` call.
...
- Add support for WALRUS `AccessToken` Pushes on every heartbeat
  see [#12](https://github.com/skorpland-community/powerbase-csharp/issues/12)
